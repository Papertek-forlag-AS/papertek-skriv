...
export default {
    ...
    sidebar: {
        ...
        cleanupDeskHint: 'Give each text a name and put it in a folder so you can find it again.',
        cleanupCount: {
            one: '{{count}} text to tidy',
            other: '{{count}} texts to tidy',
        },
        cleanupDocuments: 'Texts that need tidying',
        cleanupNeedsTitle: 'Needs a title',
        cleanupNeedsFolder: 'Needs a folder',
        cleanupRemaining: 'Still to tidy',
        cleanupOpenAndName: 'Open untitled document {{position}} and give it a name',
        cleanupOpenDocument: 'Open “{{title}}”',
        cleanupDeleteDocument: 'Move “{{title}}” to trash',
        cleanupFolderUpdated: 'Folders updated',
        cleanupMovedToTrash: '“{{title}}” was moved to trash',
        cleanupActionError: 'Could not tidy the document. Please try again.',
        allOrganized: 'All tidy!',
        allOrganizedHint: 'Every text has a name and a folder.',
        cleanupTrashHint: 'Drag here to move to trash',
        expandFolder: 'Expand',
    ...
    paragraphTrainer: {
        ...
        step1Title: 'Topic sentence',
        step1Desc: 'One sentence stating what the paragraph is about.',
        step1Hint: 'Start with one clear sentence that presents your point.',
        step1Placeholder: 'Write your topic sentence here …',
        step2Title: 'Elaboration',
        step2Desc: 'Arguments, explanations and examples that build on the topic sentence.',
        step2Hint: 'Support the topic sentence with arguments, and include at least one example.',
        step2Placeholder: 'Write your arguments and examples here …',
        step3Title: 'Closing sentence',
        step3Desc: 'One sentence that wraps up the paragraph and points back to the topic sentence.',
        step3Hint: 'Finish with a sentence that ties it all together.',
        step3Placeholder: 'Write your closing sentence here …',
        topicLabel: 'Topic',
        topicInstruction: 'Write one paragraph where you state and support your opinion on the claim:',
        deckRemaining: '{{n}} of {{total}} topics left',
        newTopic: 'New topic',
        newTopicConfirmTitle: 'Draw a new topic?',
        newTopicConfirmBody: 'What you have written in the steps will be deleted.',
        newTopicConfirmOk: 'Draw new topic',
        starters: 'Starters:',
        wordCount: '{{n}} words',
        checklistTitle: 'Check your paragraph',
        check1: 'The topic sentence states what the paragraph is about.',
        check2: 'I have supported it with at least one argument.',
        check3: 'I have included at least one example.',
        check4: 'The closing sentence points back to the topic sentence.',
        checkHint1: 'Tip: Write the topic sentence as one clear sentence.',
        checkHint2: 'Tip: Justify with "because", "therefore" or similar.',
        checkHint3: 'Tip: Include an example — "for example …".',
        checkHint4: 'Tip: Reuse a keyword from the topic sentence in the closing.',
        saveAsDocument: 'Save as document',
        saveFailed: 'Could not save the document. Try again.',
        previewTitle: 'The whole paragraph',
        previewShow: 'Show paragraph',
        previewHide: 'Hide paragraph',
        previewEmpty: 'Write in the steps above to see the whole paragraph here.',
        copy: 'Copy',
        copied: 'Paragraph copied!',
        copyFailed: 'Could not copy the paragraph.',
    },
    ...
    skriv: {
        ...
        noDocuments: 'No documents yet. Get started here:',
        emptyNewDocDesc: 'Start a new text — with or without a writing frame.',
        emptyTrainerDesc: 'Practise building good paragraphs, one at a time.',
        emptyGermanDesc: 'Practise writing tasks for the German exam.',
        ...
        frameFortelling: 'Story',
        frameFortellingDesc: 'A story with a beginning, middle and end',
        frameFaktatekst: 'Factual text',
        frameFaktatekstDesc: 'Explain a topic with facts, paragraph by paragraph',
        frameBokmelding: 'Book report',
        frameBokmeldingDesc: 'Present and review a book you have read',
        frameSoeknad: 'Application',
        frameSoeknadDesc: 'Job application — show why you are the right person',
        frameFormeltBrev: 'Formal letter',
        frameFormeltBrevDesc: 'Complaint, request or notice to an official recipient',
        frameMoreFrames: 'More writing frames',
    ...
    microsoft: {
        ...
        buttonTitle: 'Save a linked copy in Teams or OneDrive',
        close: 'Close Microsoft 365',
        loading: 'Loading…',
        retry: 'Try again',
        localAutosave: 'Skriv always saves your text locally first. The Microsoft copy cannot stop writing or local saving.',
        accountLabel: 'Connected school account',
        connect: 'Connect school account',
        reconnect: 'Reconnect',
        disconnect: 'Disconnect',
        connectionTitle: 'Connect to Microsoft 365',
        connectionBody: 'Sign in with your school account to keep an extra copy in a Teams, SharePoint, or OneDrive folder.',
        adminConfigTitle: 'Microsoft 365 is not enabled',
        adminConfigBody: 'Your school administrator must configure the connection before it can be used.',
        devConfigTitle: 'Configure test organisation',
        devConfigBody: 'Enter the public IDs from the Entra app registration and your school SharePoint host. Never enter passwords, secrets, or MFA codes.',
        clientIdLabel: 'Application ID (client ID)',
        tenantIdLabel: 'Directory ID (tenant ID)',
        sharePointHostLabel: 'School SharePoint host (for example school.sharepoint.com)',
        saveConfiguration: 'Save test setup',
        clearConfiguration: 'Clear test setup',
        localUnlinkAvailable: 'This document has local Microsoft link metadata. You can always remove it without signing in and without contacting or deleting anything in Microsoft 365.',
        folderTitle: 'Choose storage folder',
        folderBody: 'Paste a sharing link to the folder chosen by your school. The link is only used to locate the folder and is not stored.',
        folderLinkLabel: 'Teams, SharePoint, or OneDrive folder link',
        folderLinkPlaceholder: 'Paste the folder link',
        selectFolder: 'Use this folder',
        selectedFolderLabel: 'Selected folder',
        openFolder: 'Open folder',
        changeFolder: 'Change folder',
        libraryTitle: 'Documents in Microsoft 365',
        libraryEmpty: 'There are no Skriv documents in this folder yet.',
        import: 'Open in Skriv',
        editorTitle: 'Linked copy',
        linkNow: 'Save copy now',
        syncNow: 'Sync now',
        keepBoth: 'Keep both',
        unlink: 'Stop syncing',
        status: {
            localOnly: 'This document is stored locally only.',
            syncing: 'Syncing with Microsoft 365…',
            synced: 'The Microsoft 365 copy is up to date.',
            conflict: 'Both copies changed. Keep both to avoid overwriting any writing.',
            pending: 'Your local text is safe and waiting to sync.',
            needsSignIn: 'Reconnect your school account to sync.',
            forbidden: 'Your school account cannot access this folder.',
            permissionDenied: 'Your school account cannot access this folder.',
            remoteMissing: 'The Microsoft copy is missing. Your local text is still safe.',
            accountMismatch: 'This document is linked to a different school account.',
            targetRequired: 'Choose the Microsoft folder for this document.',
            targetMismatch: 'This document is linked to a different Microsoft folder.',
            error: 'Sync failed. Your local text is still safe.',
            unknown: 'The sync status is unknown. Your local text is still safe.',
        },
        state: {
            'local-only': 'Stored locally only',
            syncing: 'Syncing with Microsoft 365',
            synced: 'Synced with Microsoft 365',
            conflict: 'Sync conflict – text is safe locally',
            pending: 'Waiting for Microsoft 365',
            'needs-sign-in': 'Reconnect your school account',
            'permission-denied': 'No access to the Microsoft folder',
            'remote-missing': 'The Microsoft copy is missing',
            'account-mismatch': 'A different school account is linked',
            'target-required': 'Choose a Microsoft folder',
            'target-mismatch': 'A different Microsoft folder is selected',
            error: 'Microsoft sync failed',
        },
        error: {
            generic: 'Microsoft 365 did not respond as expected. Your local text is still safe.',
            signIn: 'Reconnect your school account and try again.',
            permission: 'Your school account cannot access this folder.',
            remoteMissing: 'The file no longer exists in Microsoft 365.',
            conflict: 'Both copies changed. Choose “Keep both” to avoid overwriting.',
            rateLimited: 'Microsoft 365 is busy right now. Wait a moment and try again.',
            invalidConfig: 'The client ID, tenant ID, or SharePoint host is invalid.',
            invalidDocument: 'The file is not a valid, safe Skriv document.',
            alreadyLinked: 'This Microsoft file is already linked to another local document.',
            alreadyInTrash: 'This Microsoft file is already in Skriv trash. Restore it from there.',
            documentTooLarge: 'The Skriv document is too large to open safely.',
            folderTooLarge: 'The Microsoft folder contains too many documents. Choose a smaller folder.',
            folderLink: 'The folder link could not be used. Copy a new link to the folder itself.',
            folderHost: 'The folder link must belong to your school SharePoint site.',
            network: 'Microsoft 365 cannot be reached. Your local text is still safe.',
        },
        notice: {
            configurationSaved: 'The test setup is saved for this tab.',
            configurationCleared: 'The test setup was cleared.',
            connected: 'The school account is connected.',
            disconnected: 'The school account is disconnected. No files were deleted.',
            folderSelected: 'The Microsoft folder is selected.',
            folderCleared: 'The folder selection was cleared. No files were deleted.',
            synced: 'The Microsoft 365 copy is up to date.',
            keptBoth: 'Both versions were kept as separate files.',
            unlinked: 'Syncing stopped. No files were deleted.',
        },
    },
