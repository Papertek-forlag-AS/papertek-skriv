...
export default {
    ...
    germanExam: {
        ...
        writeExplainBody: 'A new document with the task text and the simple-Norwegian draft is saved in the German folder. There you can write your answer in German.',
