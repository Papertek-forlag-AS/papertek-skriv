...
| `sentence-starter-drill.js` | `initSentenceStarterDrill`, `evaluateStarterSentence` | i18n, html-escape, spinner-data-nb/nn/en (dynamic) | Micro-drill (school pages): one rhetorical function + spinner starters as chips, write one sentence, two live checks. No draft/history/save |
